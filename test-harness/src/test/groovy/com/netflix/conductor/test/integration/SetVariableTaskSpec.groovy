...
class SetVariableTaskSpec extends AbstractSpecification {
    ...
    @Shared
    def setVariableWf = 'test_set_variable_wf'
    ...
    def "Test workflow with set variable task"() {
        ...
        def workflowInstanceId = startWorkflow(setVariableWf, 1,
                '', workflowInput, null)
